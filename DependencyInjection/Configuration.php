...
namespace Giak\ShibbolethBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder = new TreeBuilder('giak_shibboleth');
        // BC for symfony/config < 4.2
        $rootNode = method_exists($treeBuilder, 'getRootNode') ? $treeBuilder->getRootNode() : $treeBuilder->root('giak_shibboleth');
